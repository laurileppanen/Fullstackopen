...
beforeEach(async () => {
  ...
  describe('there are new users at db', () => {
    ...
    test('less than 3 signs username not able to create', async () => {
      ...
      expect(result.body.error).toContain('username must be at least 3 signs long')
    ...
    test('less than 3 signs password not able to create', async () => {
      ...
      expect(result.body.error).toContain('password must be at least 3 signs long')
    ...
    test('username must be unique', async () => {
      ...
      expect(result.body.error).toContain('User validation failed: username: Error, expected `username` to be unique. Value: `teme1717`')
